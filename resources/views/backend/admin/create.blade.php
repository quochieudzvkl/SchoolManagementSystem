    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('cpanel.admin.store') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control"
                                            value="{{ old('slug') }}" placeholder="tu-dong-theo-admin-name">
                                    </div>
                            ...
                            <div class="form-group @error('is_admin') has-error @enderror">
                                ...
                                <div class="col-md-6">
                                    <select name="is_admin" class="form-control">
                                        ...
                                        <option value="2" {{ old('is_admin') == '2' ? 'selected' : '' }}>
                                            Admin
                                        </option>
                                    </select>
                                    @error('is_admin')
